...
"""
Performance metrics with emphasis on deconvolved signal superiority.
FIXED: Ensures proper precision-recall curve data generation and storage.
"""
import numpy as np
from sklearn.metrics import (accuracy_score, precision_score, recall_score,
...
def calculate_metrics(y_true, y_pred, y_prob=None):
    ...
    This function acts like a comprehensive medical checkup - it examines
    the model's performance from multiple angles to give us a complete
    picture of how well it's working.
    ...
    y_prob : array-like, optional
        Predicted probabilities (essential for PR and ROC curves)
